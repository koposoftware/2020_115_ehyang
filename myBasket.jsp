   ...
   $(document).ready(function(){
      $(".maxBtn").click(function(){
        ...
        document.getElementsByClassName("count")[0].value = realMaxNum;
         ...
         document.getElementById("realprice").value = st;
      })  
   })
      ...
      <div class="container">
       ...
       <c:forEach items="${ basketList }" var="stock" varStatus="loop">
         <tr id = "${ stock.code }tr">
           ...
           <td align="center"><input type="button" class="buy btn btn-success" id="${ stock.code }"  data-toggle="modal" data-target="#myModal${ stock.name }" value="매수"></td>
         ...
         <!-- 비밀번호 확인 모달 -->
         <!-- Modal -->
  <div class="modal fade" id="myModal${ stock.name }" role="dialog">
